      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-lg font-medium text-gray-600 font-pj">2,157 students have said how good about us</p>
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-900 font-pj">
                        “I can't recommend this tutor service enough! My child struggled with math for years, but with
                        the personalized attention and effective teaching methods provided by their tutors, my child's
                        confidence and grades have soared. The tutors are not only knowledgeable but also patient and
                        encouraging. Thank you for making such a positive impact on my child's academic journey!”
                      </p>
                    </blockquote>
                  </div>
