    ...
    <section id="features" className="py-12 bg-white sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-base leading-7 text-black sm:mt-8 font-pj">This is why we are excellent</p>
        </div>
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
            ...
            <p className="mt-5 text-base text-black font-pj">
              At Academic Excellence Tutoring, we prioritize your success by offering robust support services tailored
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p className="mt-5 text-base text-black font-pj">
              At Academic Excellence Tutoring, we believe in fostering not just academic achievement but personal and
              intellectual growth.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <p className="mt-5 text-base text-black font-pj">
              Our onboarding process is seamless and personalized, ensuring that each student feels welcomed and
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <p className="mt-5 text-base text-black font-pj">
              Our educational product is designed with one goal in mind: to empower students to reach their full
              academic potential.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p className="mt-5 text-base text-black font-pj">
              We strive to deliver nothing but the best in terms of content, teaching methodologies, and student support
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <p className="mt-5 text-base text-black font-pj">
              Through our tailored approach, expert tutors, and comprehensive support systems, we empower students to
              achieve their academic goals and realize their full potential
            </p>
          </div>
        </div>
      </div>
